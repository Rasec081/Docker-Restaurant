...
// DBMenuRepository usa la conexión global de BD
type DBMenuRepository struct {
	DB *sql.DB
}

func (r *DBMenuRepository) GetByID(id int) (*models.Menu, error) {
...
func (r *DBMenuRepository) Create(menu *models.Menu) error {
	err := r.DB.QueryRow(
...
func (r *DBMenuRepository) Update(menu *models.Menu) error {
...
func (r *DBMenuRepository) Delete(id int) error {
